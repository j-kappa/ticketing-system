...
export const STATUS_CONFIG = {
  new: { label: 'New', color: 'bg-emerald-500', textColor: 'text-emerald-800', bgLight: 'bg-emerald-100' },
  in_progress: { label: 'In Progress', color: 'bg-yellow-500', textColor: 'text-yellow-700', bgLight: 'bg-yellow-100' },
  resolved: { label: 'Resolved', color: 'bg-teal-500', textColor: 'text-teal-700', bgLight: 'bg-teal-100' },
